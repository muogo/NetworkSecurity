...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)-> ModelTrainerArtifact:
        try:
            ...
            train_arr = load_numoy_array_data(train_file_path)
            test_arr = load_numoy_array_data(test_file_path)
            ...
            model_trainer_artifacet=self.train_model(x_train,y_train,x_test,y_test)
            return model_trainer_artifacet
